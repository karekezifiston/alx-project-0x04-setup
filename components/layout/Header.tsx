...
import { useCount } from "@/context/CountContext"; // for Context API
// For Redux version, replace useCount with useSelector

const Header: React.FC = () => {
  const pathname = usePathname();
  const { count } = useCount(); // Redux: const count = useSelector(...)
